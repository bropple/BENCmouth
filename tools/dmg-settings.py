# dmgbuild settings for the BENCmouth disk image.
#
...
#
#   dmgbuild -s tools/dmg-settings.py -D app=BENCmouth.app BENCmouth out.dmg

import os.path

application = defines.get("app", "BENCmouth.app")     # noqa: F821 - dmgbuild
...
# H. Hex on the mounted volume: on the desktop, and in the Finder sidebar.
_icns = os.path.join(application, "Contents", "Resources", "BENCmouth.icns")
...
# and the other has to move with it - see assets/brand/README.md.

...
"                 melody. 20 to 500 Hz.\n"
"\n"
"  [glide MS]     How long the notes after it take to be reached, rather\n"
"                 than arriving in one frame. This is a slur: 40 to 80 ms\n"
"                 is where a sung one lives, and [glide 0] steps again.\n"
"                 The first note of a phrase is never glided into.\n"
"\n"
...
"\n"
"  Legato is two things and [glide] is only one of them. The other needs\n"
"  no command: put the same vowel on the next note with no consonant in\n"
"  front of it and nothing re-articulates, so the tone runs straight\n"
"  through. A word's closing consonants go at the end of the held note -\n"
"  S T R EY1 then EY1 T, which is what a singer does with \"straight\"\n"
"  across two notes. The ROLL tab's TIE button writes all of that.\n"
"\n"
...
"                 a groan.\n"
"\n"
"  [dur MS]       How long everything after it lasts, all together, until\n"
"                 the next [dur] or [pause]. The consonants keep the\n"
"                 lengths they need and the time comes out of the vowel,\n"
"                 so the note is the length it says whatever is in it.\n"
"\n"
"  The two are different questions. Under [hold 400] the syllable IY1\n"
"  sounds for 450 ms, M IY1 for 560, and S T R EY1 T for a full second -\n"
"  the vowel is what you asked for and the consonants are extra. That is\n"
"  fine while you are reading a score and hopeless on a grid, where the\n"
"  error is different for every note and adds up. [dur 400] is 400 ms.\n"
"\n"
"  A note too short for its consonants compresses them, up to about half\n"
"  length, which is what a singer does with a word that will not fit the\n"
"  beat. Shorter than that it overruns rather than pretending.\n"
"\n"
"  [pause MS]     Inserts silence here. Up to 10000 ms, and it is that\n"
"                 long in total. This is the rest between phrases, and\n"
"                 unlike everything else it happens once where it is\n"
"                 written rather than applying onward.\n"
"\n"
